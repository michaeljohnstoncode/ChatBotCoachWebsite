...
namespace ChatBotCoachWebsite.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            // User does not have an account, so we automatically create one for them.
        ...
        */
        private ChatBotCoachWebsiteUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<ChatBotCoachWebsiteUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ChatBotCoachWebsiteUser)}'. " +
                    $"Ensure that '{nameof(ChatBotCoachWebsiteUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the external login page in /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }

        private IUserEmailStore<ChatBotCoachWebsiteUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<ChatBotCoachWebsiteUser>)_userStore;
        }
    }
}
